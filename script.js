    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "משרד עו\"ד רפי צ'סטר משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'c61831b7-4636-4a01-ac8f-27329d6c1df2',
                    name: data.name || '',
                    email: data.email || '',
